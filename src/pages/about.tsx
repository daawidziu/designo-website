import styles from "../styles/views/About.module.sass";
            ...
            <main className={styles.mainContainer}>
                <section className={styles.banner}>
                    ...
                    <div className={styles.banner__content}>
                        ...
                        <p className="paragraph-primary">Founded in 2010, we are a creative agency that produces lasting
                            results for our clients. We’ve partnered with many startups, corporations, and nonprofits
                            alike to craft designs that make real impact. We’re always looking forward to creating
