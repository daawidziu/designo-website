...
import styles from "../styles/views/Contact.module.sass";
    ...
    return (
        <>
            ...
            <main>
                <section className={styles.bannerArea}>
                    <div className={styles.bannerArea__content}>
                        <div className={styles.bannerArea__textArea}>
                            ...
                            <p className="paragraph-primary">Ready to take it to the next level? Let’s talk about your
                                project or idea and find out how we can help your business grow. If you are looking for
                                unique digital experiences that’s relatable to your users, drop us a line.</p>
                        </div>
                        <form
                        ...
                        >
                            <div className={styles.inputBlock}>
                                <input
                                    ...
                                    placeholder="name"
                                />
                                {errors.name && <span> Can't be empty<img src="/assets/contact/desktop/icon-error.svg"/></span>}
                            </div>
                            <div className={styles.inputBlock}>
                                <input
                                    type="text"
                                ...
                                />
                                {errors.emailAddress && <span>Email not valid<img src="/assets/contact/desktop/icon-error.svg"/></span>
                                }
                            </div>
                            <div className={styles.inputBlock}>
                                <input
                                    ...
                                    placeholder="phone"
                                />
                                {errors.phoneNumber && <span>Can't be empty<img src="/assets/contact/desktop/icon-error.svg"/></span>}
                            </div>
                            <div className={styles.inputBlock}>
                <textarea
                ...
                />
                                {errors.message && <span className={styles.messageError}>Can't be empty<img src="/assets/contact/desktop/icon-error.svg"/></span>}
                            </div>
